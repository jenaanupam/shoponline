    ...
    public class CatalogContextSeed
    {
            ...
            int? retry = 0)
        {
            ...
            try
            {
                ...
                Console.WriteLine("CatalogContextSeed SeedAsync CatalogBrands");
            ...
            {
                Console.WriteLine("CatalogContextSeed SeedAsync CatalogBrands"+ex.InnerException);
            }
            try { 
            ...
            {
                Console.WriteLine("CatalogContextSeed SeedAsync CatalogTypes" + ex.InnerException);
            }
            try { 
            if (!catalogContext.CatalogItems.Any())
                ...
                Console.WriteLine("CatalogContextSeed SeedAsync CatalogItems end");
            }
            catch (Exception ex)
            {
                Console.WriteLine("CatalogContextSeed CatalogItems" + ex.InnerException);
